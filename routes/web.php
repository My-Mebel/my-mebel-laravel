...
Route::prefix('/admin')->namespace('App\Http\Controllers\Admin')->group(function () {
    ...
    Route::group(['middleware' => ['admin']], function () { // using our 'admin' guard (which we created in auth.php)
        ...
        Route::get('delete-vendor/{id}', 'AdminController@deleteVendor'); // Delete a vendor in view_vendor_details.blade.php (Admin Panel) using AJAX
        ...
        Route::get('products/categories', 'ProductsController@categories'); // render products.blade.php in the Admin Panel
        Route::get('products/category/{id}', 'ProductsController@category'); // Delete a product in products.blade.php
        ...
        Route::match(['get', 'post'], 'update-user/{id}', 'UserController@updateUser'); // Update a User via AJAX in admin/users/users.blade.php, check admin/js/custom.js
...
Route::namespace('App\Http\Controllers\Front')->group(function () {
    ...
    Route::get('vendor/login', 'VendorController@loginRegister'); // render vendor login_register.blade.php page
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::post('/checkout-now', 'ProductsController@checkoutNow');
