...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders_products', function (Blueprint $table) {
            ...
            $table->string('item_status')->default('Pending'); // Determined by 'vendor'-s ONLY, not 'admin'-s, in contrast to the `order_status` column in `orders` table which is determined by 'admin'-s ONLY, not 'vendor'-s    
