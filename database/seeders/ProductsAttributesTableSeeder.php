    ...
    public function run()
    {
        ...
        $productAttributesRecords = [
            ...
            [
                ...
                'price'      => 1000,
                'stock'      => 10,
                'sku'        => 'RC002-S', // SKU is similar to Product Code then hypen -Size (which is S here which means 'small' size)
                'status'     => 1
            ],
            [
                'id'         => 5,
                ...
                'price'      => 1100,
                'stock'      => 15,
                'sku'        => 'RC002-M', // SKU is similar to Product Code then hypen -Size (which is S here which means 'medium' size)
                'status'     => 1
            ],
            [
                'id'         => 6,
                ...
                'price'      => 1200,
                'stock'      => 20,
                'sku'        => 'RC002-L', // SKU is similar to Product Code then hypen -Size (which is S here which means 'large' size)
                'status'     => 1
            ],
        ];
