...
$(document).ready(function () {
    ...
    $("#table-pending").DataTable(); // in admin/orders/orders.blade.php
    $("#table-in-progress").DataTable(); // in admin/orders/orders.blade.php
    $("#table-shipped").DataTable(); // in admin/orders/orders.blade.php
    $("#table-delivered").DataTable(); // in admin/orders/orders.blade.php
    $("#table-returned").DataTable(); // in admin/orders/orders.blade.php
    ...
    $(".nav-link").not('a[href="#pending"]').removeClass("active");
