        ...
        <div class="container">
                        ...
                        <form action="{{ url('cart/add') }}" method="Post" class="post-form" id="add_to_cart_form">
                            ...
                            <div class="section-6-social-media-quantity-actions u-s-p-y-14">
                                ...
                                <div class="quantity-wrapper u-s-m-b-22">
                                    <span>Quantity:</span>
                                    <div class="quantity">
                                        <input class="quantity-text-field" type="number" name="quantity"
                                            value="1">
                                    </div>
                                </div>
                                <div>
                                    <button class="button button-outline-secondary" type="submit">Add to cart</button>
                                    <button class="button button-outline-secondary" type="submit" id="buy_now">Buy
                                        Now</button>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <!-- Details-Tab -->
                    <div class="specification-whole-container u-s-p-t-80">
                                                    ...
                                                    @foreach ($filter['filter_values'] as $value)
                                                        ...
                                                        @if (
                                                            !empty($productDetails[$filter['filter_column']]) &&
                                                                $productDetails[$filter['filter_column']] == $value['filter_value']
                                                        )
                    ...
                    <!-- Specifications-Tab /- -->
                    <!-- Reviews-Tab -->
                    <div class="review-whole-container u-s-p-t-80" id="reviews">
